...
logger.addHandler(logging.FileHandler("CartPole_v1_NEAT_performance.csv"))
...
class NEATModel():
    ...
    def load(self):
        with open("./model_CartPole_v1_NEAT.pt", 'rb') as f:
            self.model = pickle.load(f)

    def save(self):
        with open("./model_CartPole_v1_NEAT.pt", 'wb') as f:
